...
def first_start():
    ...
    ltext1=Label(lwindow, background=bg, foreground=fg, font="arial 10 bold", text="Please choose a language for Mukotes.\nMukotes için lütfen bir dil seçin.")
    ltext1.pack()
...
if os.path.isdir("/home/"+username+"/Notes"):
    ...
    if os.path.isfile(en):
        ...
        sobutton=Button(window, font="arial 10", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, borderwidth="3", background=button_bg, text="Settings",command=settings)
    elif os.path.isfile(tr):
        ...
        sobutton=Button(window, font="arial 10", cursor="hand2", activebackground=a_button_bg, activeforeground=a_button_fg, foreground=button_fg, borderwidth="3", background=button_bg, text="Ayarlar",command=settings)     
