...
appname="Mukotes" # Don't forget to change this! This is necessary for Apiutaller.
appfolder="/usr/bin/" # Don't forget to change this! This is necessary for Apiutaller.
appfileold="mukotes.py" # Don't forget to change this! This is necessary for Apiutaller.
appfilenew="mukotes" # Don't forget to change this! This is necessary for Apiutaller.
policyfile=any # Options: policy file and any
appdesktopfile="mukotes.desktop" # Options: desktop file and any
mainappfolder="/usr/local/bin/" # Options: Your way for your main app folder or any
mainappfoldername="mukotes" # Options your main app folder for icon, modules etc. or any
