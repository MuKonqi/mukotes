...
appname="Mukotes" # Option: "<your program name>"
appfolder="/usr/bin/" # Option: "<your main code folder>"
appfileold="mukotes.py" # Option: "<your main code file old name>"
appfilenew="mukotes" # Option: "<your main code file new name>"
policyfile=any # Options: "<your policy file>" and any
appdesktopfile="mukotes.desktop" # Options: "<your desktop file>" and any
mainappfolder="/usr/local/bin/" # Options: "<your way to main app folder>" and any
mainappfoldername="mukotes" # Options: "<your main app folder name for icons, modules etc.>" and any
